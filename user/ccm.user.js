...
ccm.component( {
  ...
  Instance: function () {
    ...
    this.init = function ( callback ) {
      ...
      if ( self.context ) { var context = ccm.context.find( self, 'user' ); self.context = context && context.context || context || false; }
    ...
    this.logout = function ( callback ) {
      ...
      switch ( my.sign_on ) {
        case 'guest':
          ...
          break;
        case 'demo':
          ccm.load( [ 'https://logout@kaul.inf.h-brs.de/login/demo_logout.php', { realm: 'hbrsinfkaul' } ], success );
          break;
        case 'hbrsinfkaul':
