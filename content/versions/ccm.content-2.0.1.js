 ...
 * @version 2.0.1
 * @changes
 * version 2.0.1: bugfix for ccm.start dependency
    ...
    Instance: function () {
      ...
      this.init = function ( callback ) {
        ...
        function collectDependencies( node ) {
          ...
          self.ccm.helper.makeIterable( node.children ).map( function ( child ) {
            ...
            self.dependencies.push( [ 'ccm.instance', component, config ] );
      ...
      this.start = function ( callback ) {
        ...
        function solveDependencies() {
          ...
          self.ccm.helper.solveDependency( my.dependencies, i++, function ( instance ) {
